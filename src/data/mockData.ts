...
export const initialChats: Chat[] = [
  ...
  { id: 'devops', name: 'DevOps Hub', type: 'group', avatar: 'DH', avatarColor: '200 70% 50%', muted: false, pinned: true, unread: 12, lastMessage: 'Pipeline failed on staging', lastMessageSender: 'Mike', lastTime: '13:58', memberCount: 8, members: [users.alex, users.sarah, users.mike, users.emma], bio: 'DevOps team discussions', role: 'owner', permissions: { sendMessages: true, sendMedia: true, sendStickers: true, sendPolls: true, addMembers: true, pinMessages: true, changeInfo: true }, slowMode: 0, chatHistoryForNewMembers: true, admins: [{ userId: 'me', title: 'Creator', permissions: { changeInfo: true, postMessages: true, editMessages: true, deleteMessages: true, banUsers: true, inviteUsers: true, pinMessages: true, manageVideoChats: true, stayAnonymous: false, addAdmins: true } }, { userId: 'alex', title: 'Moderator', permissions: { changeInfo: false, postMessages: true, editMessages: true, deleteMessages: true, banUsers: true, inviteUsers: true, pinMessages: true, manageVideoChats: false, stayAnonymous: false, addAdmins: false } }], inviteLinks: [{ id: 'inv1', link: 't.me/+abc123xyz', uses: 12, maxUses: 50, createdBy: 'me' }] },
  { id: 'techblog', name: 'Tech Insider', type: 'channel', avatar: 'TI', avatarColor: '15 85% 55%', muted: false, pinned: false, unread: 3, lastMessage: 'React 20 is here — everything you need to know', lastTime: '10:30', isPublic: true, description: 'Latest tech news and insights. Updated daily.', subscriberCount: 12847, commentsEnabled: true, reactionsEnabled: true, username: '@techinsider', role: 'owner', signMessages: false, autoTranslate: false, directMessages: true, admins: [{ userId: 'me', title: 'Owner', permissions: { changeInfo: true, postMessages: true, editMessages: true, deleteMessages: true, banUsers: true, inviteUsers: true, pinMessages: true, manageVideoChats: true, stayAnonymous: false, addAdmins: true } }], inviteLinks: [{ id: 'inv2', link: 't.me/+tech456def', uses: 340, createdBy: 'me' }] },
  { id: 'design', name: 'UI/UX Designers', type: 'channel', avatar: 'UX', avatarColor: '280 65% 55%', muted: false, pinned: false, unread: 0, lastMessage: 'New Figma plugin for dark mode testing', lastTime: 'Yesterday', isPublic: false, description: 'A private community for UI/UX designers.', subscriberCount: 943, commentsEnabled: true, reactionsEnabled: true, role: 'owner', admins: [{ userId: 'me', title: 'Owner', permissions: { changeInfo: true, postMessages: true, editMessages: true, deleteMessages: true, banUsers: true, inviteUsers: true, pinMessages: true, manageVideoChats: true, stayAnonymous: false, addAdmins: true } }], inviteLinks: [] },
  // Archived chats
