...
export const initialMessages: Record<string, Message[]> = {
  ...
  techblog: [
    ...
    { id: 't3', chatId: 'techblog', senderId: 'techblog', senderName: 'Tech Insider', text: '🔒 Security alert: New vulnerability found in popular npm packages. Update your dependencies ASAP.', time: '18:00', date: '2026-02-09', isOwn: false, read: true, type: 'message', views: 45200, comments: 89, shares: 1200, reactions: [{ emoji: '😮', users: ['me'] }] },
  ],
  design: [
